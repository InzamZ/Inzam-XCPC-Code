...
int dfs(int i, int j) {
    ...
    if (i == 3 && j == 1 && imap[1][3] + imap[1][4] + imap[2][3] + imap[2][4] != 34) return 0;
    if (i == 4 && j == 3 && imap[3][1] + imap[3][2] + imap[4][1] + imap[4][2] != 34) return 0;
    if (i == 5 && j == 1 && imap[3][3] + imap[3][4] + imap[4][3] + imap[4][4] != 34) return 0;
    if (i == 5 && j == 1 && imap[1][1] + imap[2][2] + imap[3][3] + imap[4][4] != 34) return 0;
    if (i == 4 && j == 2 && imap[4][1] + imap[3][2] + imap[2][3] + imap[1][4] != 34) return 0;
