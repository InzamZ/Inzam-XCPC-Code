...
- $$
  dp[0][S][0] = 1 \\
  dp[i][j][0] = \sum _{k \in adj(j)} dp[i-1][k][0] &\text j \neq X \\
  dp[i][j][1] = \sum _{k \in adj(j)} dp[i-1][k][1] &\text j \neq X \\
  dp[i][j][0] = \sum _{k \in adj(j)} dp[i-1][k][1] &\text j = X \\
  dp[i][j][1] = \sum _{k \in adj(j)} dp[i-1][k][1] &\text j = X
  $$
